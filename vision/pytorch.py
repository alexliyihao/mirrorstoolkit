...
class negative_one(object):
    """
    This class have the normalizations when working with [-1,1] tensor rather than [0,1]
    To be honest I don't like [-1,1] solution so I put them in this individual class
    """
    def __init__(self):
        pass
